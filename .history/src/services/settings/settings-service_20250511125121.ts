...
export class SettingsService implements SettingsManager {
  ...
  getEvolutionSettings(): TrackingConfig {
    return JSON.parse(JSON.stringify(this.settings.evolution));
  }
  ...
  getAutoImprovementSettings(): AutoImprovementConfig {
    return JSON.parse(JSON.stringify(this.settings.autoImprovement));
  }
  ...
  getConversationSettings(): any {
    return JSON.parse(JSON.stringify(this.settings.conversation));
  }
