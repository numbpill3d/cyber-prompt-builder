...
export class EvaluationLogger {
   ...
   */
  private calculateAverageMetrics(metrics: any[]): Record<string, number> {
   ...
   */
  public async generateAgentScorecard(agentId: string): Promise<any> {
    await this.initialize();
   ...
   */
  private calculateMetricTrends(metrics: any[]): Record<string, any> {
   ...
   * Calculate task type breakdown
   */
  private calculateTaskTypeBreakdown(metrics: any[]): Record<string, any> {
