...
export class ErrorHandler {
  ...
  private convertToAppError(error: Error, context?: Record<string, unknown>): AppError {
  ...
  public withFallback<T, Args extends unknown[]>(
  ...
  public withRetry<T, Args extends unknown[]>(
    fn: (...args: Args) => Promise<T>,
    maxRetries: number = 3,
    delayMs: number = 1000,
