                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: "minimal" | "normal" | "detailed") => setTtsSettings({
                          ...ttsSettings,
                          codeConfig: {
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: "perSession" | "perPrompt" | "custom") => setTrackingConfig({...trackingConfig, trackingFrequency: value})}
